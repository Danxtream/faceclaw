...
import { bearingDegrees, haversineMeters, RouteFollower, type RouteProgress } from "../navigate/route-follower";
import { drawManeuverGlyph } from "../navigate/maneuver-icons";
